...
void driver(string inFile, string outFile)
{
    ...
    for (size_t looper = 0; looper < asciiSize; looper++)
    {
        ...
        if (counter > 15) {
            ...
            insertionSort(inlineArrNum, begin + 1, end);
        }
    }
    ...
    if (checker)
    {
        cout << "Data sorting:" << chrono::duration<double>(end3 - begin3).count() << endl;
...
int main()
{
    ...
    cout << "1k" << endl;
    driver("../1k.txt", "../qs_inline_1k.txt");
    cout << "1m" << endl;
    driver("../1m.txt", "../qs_inline_1m.txt");
    cout << "2m" << endl;
    driver("../2m.txt", "../qs_inline_2m.txt");
    cout << "3m" << endl;
    driver("../3m.txt", "../qs_inline_3m.txt");
    cout << "10m" << endl;
    driver("../10m.txt", "../qs_inline_10m.txt");
